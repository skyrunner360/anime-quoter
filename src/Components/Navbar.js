...
export default function Navbar(props) {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <form>
      ...
      <button onClick={props.sAnime} className="mx-1 inline-flex items-center btn-success border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base md:mt-0">Search Anime</button>
      <button onClick={props.cAnime} className="mx-1 inline-flex items-center btn-success border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base md:mt-0">Search Character</button>
    </form>
    </div>
  </div>
</header>
